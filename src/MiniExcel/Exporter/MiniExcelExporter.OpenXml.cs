...
public static partial class MiniExcel
{
    ...
    {
        [CreateSyncVersion]
        public static async Task AddPictureXlsxAsync(string path, CancellationToken cancellationToken = default, params MiniExcelPicture[] images)
        {
        ...
        [CreateSyncVersion]
        public static async Task AddPictureXlsxAsync(Stream excelStream, CancellationToken cancellationToken = default, params MiniExcelPicture[] images)
        {
            await MiniExcelPictureImplement.AddPictureAsync(excelStream, cancellationToken, images).ConfigureAwait(false);
        }

        [CreateSyncVersion]
        public static async Task<int> InsertXlsxSheetAsync(string path, object value, string? sheetName = "Sheet1", bool printHeader = true, bool overwriteSheet = false, OpenXmlConfiguration? configuration = null, CancellationToken cancellationToken = default)
        {
        ...
        [CreateSyncVersion]
        public static async Task<int> InsertXlsxSheetAsync(Stream stream, object value, string? sheetName = "Sheet1", 
        ...
        [CreateSyncVersion]
        public static async Task<int[]> ExportXlsxAsync(string path, object value, bool printHeader = true, 
        ...
        [CreateSyncVersion]
        public static async Task<int[]> ExportXlsxAsync(Stream stream, object value, bool printHeader = true, string? sheetName = "Sheet1", 
