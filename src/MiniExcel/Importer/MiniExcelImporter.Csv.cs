...
public static partial class MiniExcel
{
    public static partial class Importer
    {
        ...
        [CreateSyncVersion]
        public static async IAsyncEnumerable<T> QueryCsvAsync<T>(string path, CsvConfiguration? configuration = null,
        ...
        [CreateSyncVersion]
        public static async IAsyncEnumerable<T> QueryCsvAsync<T>(Stream stream, bool treatHeaderAsData = false, 
        ...
        [CreateSyncVersion]
        public static async IAsyncEnumerable<dynamic> QueryCsvAsync(string path, bool useHeaderRow = false, 
            CsvConfiguration? configuration = null,
            [EnumeratorCancellation] CancellationToken cancellationToken = default)
        {
            using var stream = FileHelper.OpenSharedRead(path);
        ...
        [CreateSyncVersion]
        public static async IAsyncEnumerable<dynamic> QueryCsvAsync(Stream stream, bool useHeaderRow = false,
            CsvConfiguration? configuration = null,
            [EnumeratorCancellation] CancellationToken cancellationToken = default)
        {
...
#pragma warning restore CA2007
        ...
        /// </summary>
        [CreateSyncVersion]
        public static async Task<DataTable> QueryCsvAsDataTableAsync(string path, bool useHeaderRow = true,
        ...
        /// </summary>
        [CreateSyncVersion]
        public static async Task<DataTable> QueryCsvAsDataTableAsync(Stream stream, bool useHeaderRow = true,
            CsvConfiguration? configuration = null, CancellationToken cancellationToken = default)
        {
...
#pragma warning restore CA2007
        ...
        [CreateSyncVersion]
        public static async Task<ICollection<string>> GetCsvColumnsAsync(string path, bool useHeaderRow = false,
            CsvConfiguration? configuration = null, CancellationToken cancellationToken = default)
        {
            using var stream = FileHelper.OpenSharedRead(path);
        ...
        [CreateSyncVersion]
        public static async Task<ICollection<string>> GetCsvColumnsAsync(Stream stream, bool useHeaderRow = false,
            CsvConfiguration? configuration = null, CancellationToken cancellationToken = default)
        {
...
#pragma warning restore CA2007 // Consider calling ConfigureAwait on the awaited task
        ...
        public static MiniExcelDataReader GetCsvDataReader(string path, bool useHeaderRow = false, CsvConfiguration? configuration = null)
        {
        ...
        public static MiniExcelDataReader GetCsvDataReader(Stream stream, bool useHeaderRow = false, CsvConfiguration? configuration = null)
        {
            var values = QueryCsv(stream, useHeaderRow, configuration).Cast<IDictionary<string, object?>>();
            return MiniExcelDataReader.Create(stream, values);
        }
