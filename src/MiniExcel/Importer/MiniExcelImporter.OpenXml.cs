...
public static partial class MiniExcel
{
    public static partial class Importer
    {
        ...
        [CreateSyncVersion]
        public static async IAsyncEnumerable<T> QueryXlsxAsync<T>(string path, string? sheetName = null,
            ...
            [EnumeratorCancellation] CancellationToken cancellationToken = default) where T : class, new()
        {
            ...
            var query = QueryXlsxAsync<T>(stream, sheetName, startCell, treatHeaderAsData, configuration, cancellationToken);
        ...
        public static async IAsyncEnumerable<T> QueryXlsxAsync<T>(Stream stream, string? sheetName = null,
            string startCell = "A1", bool treatHeaderAsData = false, OpenXmlConfiguration? configuration = null,
            [EnumeratorCancellation] CancellationToken cancellationToken = default) where T : class, new()
        {
        ...
        [CreateSyncVersion]
        public static async IAsyncEnumerable<dynamic> QueryXlsxAsync(string path, bool useHeaderRow = false,
            string? sheetName = null, string startCell = "A1", OpenXmlConfiguration? configuration = null,
            [EnumeratorCancellation] CancellationToken cancellationToken = default)
        {
            using var stream = FileHelper.OpenSharedRead(path);
            await foreach (var item in QueryXlsxAsync(stream, useHeaderRow, sheetName, startCell, configuration, cancellationToken).ConfigureAwait(false))
                yield return item;
        }

        [CreateSyncVersion]
        [SuppressMessage("Reliability", "CA2007:Do not directly await a Task")]
        public static async IAsyncEnumerable<dynamic> QueryXlsxAsync(Stream stream, bool useHeaderRow = false,
            string? sheetName = null, string startCell = "A1", OpenXmlConfiguration? configuration = null,
            [EnumeratorCancellation] CancellationToken cancellationToken = default)
        {
        ...
        /// <returns></returns>
        [CreateSyncVersion]
        public static async IAsyncEnumerable<dynamic> QueryRangeXlsxAsync(string path, bool useHeaderRow = false,
            string? sheetName = null, string startCell = "A1", string endCell = "", OpenXmlConfiguration? configuration = null,
            [EnumeratorCancellation] CancellationToken cancellationToken = default)
        {
            using var stream = FileHelper.OpenSharedRead(path);
            await foreach (var item in QueryRangeXlsxAsync(stream, useHeaderRow, sheetName, startCell, endCell, configuration, cancellationToken).ConfigureAwait(false))
                yield return item;
        }

        [CreateSyncVersion]
        [SuppressMessage("Reliability", "CA2007:Do not directly await a Task")]
        public static async IAsyncEnumerable<dynamic> QueryRangeXlsxAsync(Stream stream, bool useHeaderRow = false,
            string? sheetName = null, string startCell = "A1", string endCell = "", OpenXmlConfiguration? configuration = null,
            [EnumeratorCancellation] CancellationToken cancellationToken = default)
        {
            using var excelReader = await OpenXmlReader.CreateAsync(stream, configuration, cancellationToken).ConfigureAwait(false);
        ...
        {
            using var stream = FileHelper.OpenSharedRead(path);
            await foreach (var item in QueryRangeXlsxAsync(stream, useHeaderRow, sheetName, startRowIndex, startColumnIndex, endRowIndex, endColumnIndex, configuration, cancellationToken).ConfigureAwait(false))
                yield return item;
        }
        ...
        /// </summary>
        [CreateSyncVersion]
        public static async Task<DataTable> QueryXlsxAsDataTableAsync(string path, bool useHeaderRow = true,
            string? sheetName = null, string startCell = "A1", OpenXmlConfiguration? configuration = null,
            CancellationToken cancellationToken = default)
        {
            using var stream = FileHelper.OpenSharedRead(path);
            return await QueryXlsxAsDataTableAsync(stream, useHeaderRow, sheetName, startCell, configuration, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// </summary>
        [CreateSyncVersion]
        public static async Task<DataTable> QueryXlsxAsDataTableAsync(Stream stream, bool useHeaderRow = true,
            string? sheetName = null, string startCell = "A1", OpenXmlConfiguration? configuration = null,
            CancellationToken cancellationToken = default)
        {
            /*Issue #279*/
...
#pragma warning restore CA2007
        ...
        [CreateSyncVersion]
        public static async Task<List<string>> GetSheetNamesAsync(string path, OpenXmlConfiguration? config = null,
            CancellationToken cancellationToken = default)
        {
            using var stream = FileHelper.OpenSharedRead(path);
        ...
        [CreateSyncVersion]
        public static async Task<List<string>> GetSheetNamesAsync(Stream stream, OpenXmlConfiguration? config = null,
            CancellationToken cancellationToken = default)
        {
...
#pragma warning disable CA2000 // Dispose objects before losing scope
            var archive = new OpenXmlZip(stream);
#pragma warning restore CA2000 // Dispose objects before losing scope
        ...
        [CreateSyncVersion]
        public static async Task<List<SheetInfo>> GetSheetInformationsAsync(Stream stream, OpenXmlConfiguration? config = null, CancellationToken cancellationToken = default)
        {
            config ??= OpenXmlConfiguration.DefaultConfig;
        ...
        [CreateSyncVersion]
        public static async Task<IList<ExcelRange>> GetSheetDimensionsAsync(Stream stream, CancellationToken cancellationToken = default)
        {
        ...
        [CreateSyncVersion]
        public static async Task<ICollection<string>> GetXlsxColumnsAsync(string path, bool useHeaderRow = false,
            string? sheetName = null, string startCell = "A1", OpenXmlConfiguration? configuration = null,
            CancellationToken cancellationToken = default)
        {
            using var stream = FileHelper.OpenSharedRead(path);
            return await GetXlsxColumnsAsync(stream, useHeaderRow, sheetName, startCell, configuration, cancellationToken).ConfigureAwait(false);
        }

        [CreateSyncVersion]
        public static async Task<ICollection<string>> GetXlsxColumnsAsync(Stream stream, bool useHeaderRow = false,
            string? sheetName = null, string startCell = "A1", OpenXmlConfiguration? configuration = null,
            CancellationToken cancellationToken = default)
        {
#pragma warning disable CA2007 // Consider calling ConfigureAwait on the awaited task
            await using var enumerator = QueryXlsxAsync(stream, useHeaderRow, sheetName, startCell, configuration, cancellationToken).GetAsyncEnumerator(cancellationToken);
#pragma warning restore CA2007 // Consider calling ConfigureAwait on the awaited task
        ...
        public static MiniExcelDataReader GetXlsxDataReader(string path, bool useHeaderRow = false,
            string? sheetName = null, string startCell = "A1", OpenXmlConfiguration? configuration = null)
        {
            var stream = FileHelper.OpenSharedRead(path);
            var values = QueryXlsx(stream, useHeaderRow, sheetName, startCell, configuration).Cast<IDictionary<string, object?>>();

            return new MiniExcelDataReader(stream, values);
        }

        public static MiniExcelDataReader GetXlsxDataReader(Stream stream, bool useHeaderRow = false,
            string? sheetName = null, string startCell = "A1", OpenXmlConfiguration? configuration = null)
        {
            var values = QueryXlsx(stream, useHeaderRow, sheetName, startCell, configuration).Cast<IDictionary<string, object?>>();
            return new MiniExcelDataReader(stream, values);
