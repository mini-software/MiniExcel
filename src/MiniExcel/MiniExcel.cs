...
public static partial class MiniExcel
{
    ...
    public static MiniExcelDataReader GetReader(string path, bool useHeaderRow = false, string? sheetName = null, ExcelType excelType = ExcelType.UNKNOWN, string startCell = "A1", IConfiguration? configuration = null)
    {
        ...
        return type switch
        {
            ExcelType.XLSX => ExcelImporter.GetDataReader(path, useHeaderRow, sheetName, startCell, configuration as NewOpenXmlConfiguration),
    ...
    public static MiniExcelDataReader GetReader(this Stream stream, bool useHeaderRow = false, string? sheetName = null, ExcelType excelType = ExcelType.UNKNOWN, string startCell = "A1", IConfiguration? configuration = null)
    {
        ...
        return type switch
        {
            ExcelType.XLSX => ExcelImporter.GetDataReader(stream, useHeaderRow, sheetName, startCell, configuration as NewOpenXmlConfiguration),
    ...
    public static IAsyncEnumerable<T> QueryAsync<T>(this Stream stream, string? sheetName = null, ExcelType excelType = ExcelType.UNKNOWN, string startCell = "A1", IConfiguration? configuration = null, bool hasHeader = true, CancellationToken cancellationToken = default) where T : class, new()
    {
        ...
        return type switch
        {
            ExcelType.XLSX => ExcelImporter.QueryAsync<T>(stream, sheetName, startCell, hasHeader, configuration as NewOpenXmlConfiguration, false, cancellationToken),
            ExcelType.CSV => CsvImporter.QueryAsync<T>(stream, hasHeader, configuration as Csv.CsvConfiguration, false, cancellationToken),
            _ => throw new InvalidDataException($"Type {type} is not a valid Excel type")
        };
    }
    ...
    public static IAsyncEnumerable<dynamic> QueryAsync(this Stream stream, bool useHeaderRow = false, string? sheetName = null, ExcelType excelType = ExcelType.UNKNOWN, string startCell = "A1", IConfiguration? configuration = null, CancellationToken cancellationToken = default)
    {
        ...
        return type switch
        {
            ExcelType.XLSX => ExcelImporter.QueryAsync(stream, useHeaderRow, sheetName, startCell, configuration as NewOpenXmlConfiguration, false, cancellationToken),
            ExcelType.CSV => CsvImporter.QueryAsync(stream, useHeaderRow, configuration as Csv.CsvConfiguration,false, cancellationToken),
            _ => throw new InvalidDataException($"Type {type} is not a valid Excel type")
        };
    }
    ...
    public static IAsyncEnumerable<dynamic> QueryRangeAsync(string path, bool useHeaderRow = false, string? sheetName = null, ExcelType excelType = ExcelType.UNKNOWN, string startCell = "A1", string endCell = "", IConfiguration? configuration = null, CancellationToken cancellationToken = default)
    {
        ...
        return type switch
        {
            ExcelType.XLSX => ExcelImporter.QueryRangeAsync(path, useHeaderRow, sheetName, startCell, endCell, configuration as NewOpenXmlConfiguration, cancellationToken),
    ...
    public static IAsyncEnumerable<dynamic> QueryRangeAsync(this Stream stream, bool useHeaderRow = false, string? sheetName = null, ExcelType excelType = ExcelType.UNKNOWN, string startCell = "A1", string endCell = "", IConfiguration? configuration = null, CancellationToken cancellationToken = default)
    {
        ...
        return type switch
        {
            ExcelType.XLSX => ExcelImporter.QueryRangeAsync(stream, useHeaderRow, sheetName, startCell, endCell, configuration as NewOpenXmlConfiguration, false, cancellationToken),
            ExcelType.CSV => CsvImporter.QueryAsync(stream, useHeaderRow, configuration as Csv.CsvConfiguration, false, cancellationToken),
            _ => throw new InvalidDataException($"Type {type} is not a valid Excel type")
        };
    }
    ...
    public static IAsyncEnumerable<dynamic> QueryRangeAsync(string path, bool useHeaderRow = false, string? sheetName = null, ExcelType excelType = ExcelType.UNKNOWN, int startRowIndex = 1, int startColumnIndex = 1, int? endRowIndex = null, int? endColumnIndex = null, IConfiguration? configuration = null, CancellationToken cancellationToken = default)
    {
        ...
        return type switch
        {
            ExcelType.XLSX => ExcelImporter.QueryRangeAsync(path, useHeaderRow, sheetName, startRowIndex, startColumnIndex, endRowIndex, endColumnIndex, configuration as NewOpenXmlConfiguration, cancellationToken),
            ExcelType.CSV => throw new NotSupportedException("QueryRange is not supported for csv"),
            _ => throw new InvalidDataException($"Type {type} is not a valid Excel type")
        };
    }
    ...
    public static IAsyncEnumerable<dynamic> QueryRangeAsync(this Stream stream, bool useHeaderRow = false, string? sheetName = null, ExcelType excelType = ExcelType.UNKNOWN, int startRowIndex = 1, int startColumnIndex = 1, int? endRowIndex = null, int? endColumnIndex = null, IConfiguration? configuration = null, CancellationToken cancellationToken = default)
    {
        ...
        return type switch
        {
            ExcelType.XLSX => ExcelImporter.QueryRangeAsync(stream, useHeaderRow, sheetName, startRowIndex, startColumnIndex, endRowIndex, endColumnIndex, configuration as NewOpenXmlConfiguration, false, cancellationToken),
            ExcelType.CSV => throw new NotSupportedException("QueryRange is not supported for csv"),
            _ => throw new InvalidDataException($"Type {type} is not a valid Excel type")
        };
    }
    ...
    public static async Task SaveAsByTemplateAsync(string path, string templatePath, object value, IConfiguration? configuration = null, CancellationToken cancellationToken = default) 
        => await ExcelTemplater.FillTemplateAsync(path, templatePath, value, true, configuration as NewOpenXmlConfiguration, cancellationToken).ConfigureAwait(false);
    ...
    public static async Task SaveAsByTemplateAsync(string path, byte[] templateBytes, object value, IConfiguration? configuration = null)
        => await ExcelTemplater.FillTemplateAsync(path, templateBytes, value, true, configuration as NewOpenXmlConfiguration).ConfigureAwait(false);
    ...
    public static async Task SaveAsByTemplateAsync(this Stream stream, string templatePath, object value, IConfiguration? configuration = null)
        => await ExcelTemplater.FillTemplateAsync(stream, templatePath, value, configuration as NewOpenXmlConfiguration).ConfigureAwait(false);
    ...
    public static async Task SaveAsByTemplateAsync(this Stream stream, byte[] templateBytes, object value, IConfiguration? configuration = null)
        => await ExcelTemplater.FillTemplateAsync(stream, templateBytes, value, configuration as NewOpenXmlConfiguration).ConfigureAwait(false);
    ...
    public static async Task SaveAsByTemplateAsync(string path, Stream templateStream, object value, IConfiguration? configuration = null)
        => await ExcelTemplater.FillTemplateAsync(path, templateStream, value, true, configuration as NewOpenXmlConfiguration).ConfigureAwait(false);
    ...
    public static async Task SaveAsByTemplateAsync(this Stream stream, Stream templateStream, object value, IConfiguration? configuration = null)
        => await ExcelTemplater.FillTemplateAsync(stream, templateStream, value, configuration as NewOpenXmlConfiguration).ConfigureAwait(false);
    ...
    public static async Task MergeSameCellsAsync(string mergedFilePath, string path, ExcelType excelType = ExcelType.XLSX, IConfiguration? configuration = null, CancellationToken cancellationToken = default)
    {
        ...
        await ExcelTemplater.MergeSameCellsAsync(mergedFilePath, path, configuration as NewOpenXmlConfiguration, cancellationToken).ConfigureAwait(false);
    }
    ...
    public static async Task MergeSameCellsAsync(this Stream stream, string path, ExcelType excelType = ExcelType.XLSX, IConfiguration? configuration = null, CancellationToken cancellationToken = default)
    {
        ...
        await ExcelTemplater.MergeSameCellsAsync(stream, path, configuration as NewOpenXmlConfiguration, cancellationToken).ConfigureAwait(false);
    }
    ...
    public static async Task MergeSameCellsAsync(this Stream stream, byte[] filePath, ExcelType excelType = ExcelType.XLSX, IConfiguration? configuration = null, CancellationToken cancellationToken = default)
    {
        ...
        await ExcelTemplater.MergeSameCellsAsync(stream, filePath, configuration as NewOpenXmlConfiguration, cancellationToken).ConfigureAwait(false);
    }
    ...
    public static async Task<DataTable> QueryAsDataTableAsync(this Stream stream, bool useHeaderRow = true, string? sheetName = null, ExcelType excelType = ExcelType.UNKNOWN, string startCell = "A1", IConfiguration? configuration = null, CancellationToken cancellationToken = default)
    {
        ...
        return type switch
        {
            ExcelType.XLSX => await ExcelImporter.QueryAsDataTableAsync(stream, useHeaderRow, sheetName, startCell, configuration as NewOpenXmlConfiguration, false, cancellationToken).ConfigureAwait(false),
            ExcelType.CSV => await CsvImporter.QueryAsDataTableAsync(stream, useHeaderRow, configuration as Csv.CsvConfiguration, false, cancellationToken).ConfigureAwait(false),
            _ => throw new InvalidDataException($"Excel type {type} is not a valid Excel type")
        };
    }

    [CreateSyncVersion]
    public static async Task<List<string>> GetSheetNamesAsync(string path, NewOpenXmlConfiguration? config = null, CancellationToken cancellationToken = default)
        => await ExcelImporter.GetSheetNamesAsync(path, cancellationToken).ConfigureAwait(false);
    
    [CreateSyncVersion]
    public static async Task<List<string>> GetSheetNamesAsync(this Stream stream, NewOpenXmlConfiguration? config = null, CancellationToken cancellationToken = default)
        => await ExcelImporter.GetSheetNamesAsync(stream, false, cancellationToken).ConfigureAwait(false);

    [CreateSyncVersion]
    public static async Task<List<SheetInfo>> GetSheetInformationsAsync(string path, NewOpenXmlConfiguration? config = null, CancellationToken cancellationToken = default)
        => await ExcelImporter.GetSheetInformationsAsync(path, cancellationToken).ConfigureAwait(false);
    
    [CreateSyncVersion]
    public static async Task<List<SheetInfo>> GetSheetInformationsAsync(this Stream stream, NewOpenXmlConfiguration? config = null, CancellationToken cancellationToken = default)
        => await ExcelImporter.GetSheetInformationsAsync(stream, false, cancellationToken).ConfigureAwait(false);
    ...
    public static async Task<ICollection<string>> GetColumnsAsync(this Stream stream, bool useHeaderRow = false, string? sheetName = null, ExcelType excelType = ExcelType.UNKNOWN, string startCell = "A1", IConfiguration? configuration = null, CancellationToken cancellationToken = default)
    {
        ...
        return type switch
        {
            ExcelType.XLSX => await ExcelImporter.GetColumnNamesAsync(stream, useHeaderRow, sheetName, startCell, false, cancellationToken).ConfigureAwait(false),
    ...
    public static async Task<IList<ExcelRange>> GetSheetDimensionsAsync(this Stream stream, CancellationToken cancellationToken = default) 
        => await ExcelImporter.GetSheetDimensionsAsync(stream, false, cancellationToken).ConfigureAwait(false);
