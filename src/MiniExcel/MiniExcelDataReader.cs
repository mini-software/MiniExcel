...
public class MiniExcelDataReader : MiniExcelDataReaderBase
{
    ...
    internal MiniExcelDataReader(Stream stream, bool useHeaderRow = false, string? sheetName = null, ExcelType excelType = ExcelType.UNKNOWN, string startCell = "A1", IMiniExcelConfiguration? configuration = null)
    {
