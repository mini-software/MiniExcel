...
public class MiniExcelIssueTests(ITestOutputHelper output)
{
    ...
    public void TestIssue549()
    {
        ...
        var path = file.ToString();
         ...
         _exporter.ExportExcel(path, data);
        var rows =  _importer.QueryExcel(path, true).ToList();
        {
    ...
    public void TestIssue553()
    {
        ...
        var rows =  _importer.QueryExcel(path.ToString()).ToList();
    ...
    public void TestIssue289()
    {
        ...
        var rows =  _importer.QueryExcel<DescriptionEnumDto>(path.ToString()).ToList();
    ...
    public void TestIssue430()
    {
        ...
        var value = new[]
        {
         ...
         _exporter.ExportExcel(path.ToString(), value);
        var rows =  _importer.QueryExcel<TestIssue430Dto>(path.ToString()).ToArray();
    ...
    public void TestIssue_DataReaderSupportDimension()
    {
        ...
        var config = new OpenXmlConfiguration { FastMode = true };
         _exporter.ExportExcel(path.ToString(), reader, configuration: config);
    ...
    public void TestIssue370()
    {
        ...
        var value = JsonConvert.DeserializeObject<List<Dictionary<string, object>>>(json);
         _exporter.ExportExcel(path.ToString(), value, configuration: config);
    ...
    public void TestIssue360()
    {
        ...
        {
            var dt =  _importer.QueryExcelAsDataTable(path, useHeaderRow: true, sheetName: sheetName, configuration: config);
        }
    }
    ...
    {
        {
            ...
            var reader = table.CreateDataReader();
             _exporter.ExportExcel(path.ToString(), reader);
            var xml = SheetHelper.GetZipFileContent(path.ToString(), "xl/worksheets/sheet1.xml");
        ...
        }
        {
            ...
            using var path = AutoDeletingPath.Create();
            var reader = table.CreateDataReader();
             _exporter.ExportExcel(path.ToString(), reader, false);
            var xml = SheetHelper.GetZipFileContent(path.ToString(), "xl/worksheets/sheet1.xml");
    ...
    public void TestIssue401(bool autoFilter, int count)
    {
        ...
        }
        {
            ...
            using var path = AutoDeletingPath.Create();
            var config = new OpenXmlConfiguration { AutoFilter = autoFilter };
             _exporter.ExportExcel(path.ToString(), reader, false, configuration: config);
...

        {
            ...
            using (var connection = new SQLiteConnection(connectionString))
            {
                ...
                {
                    var rows =  _importer.QueryExcel(stream);
    ...
    public async Task TestIssue307()
    {
        ...
        await  _exporter.ExportExcelAsync(path, value);
        Assert.Throws<IOException>(() =>  _exporter.ExportExcel(path, value));

        await  _exporter.ExportExcelAsync(path, value, overwriteFile: true);
        await Assert.ThrowsAsync<IOException>(async () => await  _exporter.ExportExcelAsync(path, value));
        await  _exporter.ExportExcelAsync(path, value, overwriteFile: true);
    }
    ...
    public void TestIssue310()
    {
        ...
        var value = new[] { new TestIssue310Dto { V1 = null }, new TestIssue310Dto { V1 = 2 } };
         _exporter.ExportExcel(path.ToString(), value);
        var rows =  _importer.QueryExcel<TestIssue310Dto>(path.ToString()).ToList();
    }
    ...
    public void TestIssue310Fix497()
    {
        ...
        var value = new[]
        {
         ...
         _exporter.ExportExcel(path.ToString(), value, configuration: new OpenXmlConfiguration { EnableWriteNullValueCell = false });
        var rows =  _importer.QueryExcel<TestIssue310Dto>(path.ToString()).ToList();
    }
    ...
    public void TestIssue343()
    {
        ...
        var rows =  _importer.QueryExcel(path.ToString(), true).ToArray();
    ...
    public void TestIssueI4YCLQ_2()
    {
        ...
        var rows =  _importer.QueryExcel<TestIssueI4YCLQ_2Dto>(path, startCell: "B2").ToList();
    ...
    public void TestIssue331_2()
    {
        ...
        using var path = AutoDeletingPath.Create();
         _exporter.ExportExcel(path.ToString(), data, configuration: config);
    ...
    public void TestIssue331()
    {
        ...
        using var path = AutoDeletingPath.Create();
         _exporter.ExportExcel(path.ToString(), data);

        var rows =  _importer.QueryExcel(path.ToString(), startCell: "A2").ToArray();
    ...
    public void TestIssueI4TXGT()
    {
        ...
        var value = new[] { new TestIssueI4TXGTDto { ID = 1, Name = "Apple", Spc = "X", Up = 6999 } };
         ...
         _exporter.ExportExcel(path, value);
        {
            var rows =  _importer.QueryExcel(path).ToList();
        ...
        {
            var rows =  _importer.QueryExcel<TestIssueI4TXGTDto>(path).ToList();
    ...
    public void TestIssue328()
    {
        ...
        var rowIndx = 0;
        using var reader =  _importer.GetExcelDataReader(path.ToString(), true);
    ...
    public void TestIssue327()
    {
        ...
        var value = new[]
        {
         ...
         _exporter.ExportExcel(path.ToString(), value);
        var rows =  _importer.QueryExcel(path.ToString(), true).ToList();
    ...
    public void TestIssue209()
    {
        try
        {
            ...
            var rows =  _importer.QueryExcel<TestIssue209Dto>(path).ToList();
        }
    ...
    public void TestIssue318()
    {
        ...
        // import to base64 string
        {
            ...
            var rows =  _importer.QueryExcel(path.ToString(), true, configuration: config).ToList();
    ...
    {
        {
            ...
            var value = new TestIssue190Dto[] { };
             _exporter.ExportExcel(path.ToString(), value, configuration: new OpenXmlConfiguration { AutoFilter = false });
    ...
    public void TestIssueI49RYZ()
    {
        ...
        using var path = AutoDeletingPath.Create();
         _exporter.ExportExcel(path.ToString(), values);
        var rows =  _importer.QueryExcel(path.ToString(), true).ToList();
    ...
    public void TestIssue283()
    {
        ...
        using (var cn = Db.GetConnection())
        {
            ...
            var rows =  _exporter.ExportExcel(path.ToString(), sheets);
    ...
    {
        {
            ...
            var rows =  _importer.QueryExcel<TestIssueI40QA5Dto>(path).ToList();
    ...
    {
        using var path = AutoDeletingPath.Create();
         _exporter.ExportExcel(path.ToString(), new[] { new { C1 = "1&2;3,4", C2 = "1&2;3,4" } });
    ...
    public void TestIssue272()
    {
        ...
        Assert.Throws<InvalidDataException>(() =>  _importer.QueryExcel(path).ToList());
    }
    ...
    public void TestIssue267()
    {
        ...
        var row =  _importer.QueryExcel(path).SingleOrDefault();
    ...
    public void TestIssueI3X2ZL()
    {
        try
        {
            ...
            var rows =  _importer.QueryExcel<IssueI3X2ZLDTO>(path, startCell: "B3").ToList();
        }
        ...
        try
        {
            ...
            var rows =  _importer.QueryExcel<IssueI3X2ZLDTO>(path).ToList();
        }
        catch (InvalidCastException ex)
        {
            Assert.Equal(
    ...
    public void Issue256()
    {
        ...
        var rows =  _importer.QueryExcel(path, false).ToList();
    ...
    public void Issue242()
    {
        ...
        Assert.Throws<InvalidDataException>(() =>  _importer.QueryExcel(stream).ToList());
    }
    ...
    public void Issue243()
    {
        ...
        var rows =  _importer.QueryExcel<Issue243Dto>(path.ToString()).ToList();
    ...
    public void Issue241()
    {
        ...
        // csv
        {
            ...
            {
                var rows =  _importer.QueryExcel<Issue241Dto>(path.ToString()).ToList();
    ...
    public void Issue235()
    {
        ...
        var rowsWritten =  _exporter.ExportExcel(path.ToString(), dataSet);
        ...
        {
            var rows =  _importer.QueryExcel(path.ToString(), true, sheetName: "users").ToList();
            Assert.Equal("Jack", rows[0].Name);
            Assert.Equal(25, rows[0].Age);
        ...
        {
            var rows =  _importer.QueryExcel(path.ToString(), true, sheetName: "department").ToList();
...
#pragma warning disable CS0618 // Type or member is obsolete
        var dt =  _importer.QueryExcelAsDataTable(path);
#pragma warning restore CS0618
    ...
    public void Issue234()
    {
        ...
        var sheets = new Dictionary<string, object>
        {
         ...
         _exporter.ExportExcel(path, sheets);
        ...
        {
            var rows =  _importer.QueryExcel(path, true, sheetName: "users").ToList();
            Assert.Equal("Jack", rows[0].Name);
            Assert.Equal(25, rows[0].Age);
            Assert.Equal("Mike", rows[1].Name);
            Assert.Equal(44, rows[1].Age);
        ...
        {
            var rows =  _importer.QueryExcel(path, true, sheetName: "department").ToList();
            Assert.Equal("01", rows[0].ID);
            Assert.Equal("HR", rows[0].Name);
            Assert.Equal("02", rows[1].ID);
            Assert.Equal("IT", rows[1].Name);
    ...
    public void Issue230()
    {
        ...
        {
            using var path = AutoDeletingPath.Create();
             _exporter.ExportExcel(path.ToString(), reader, printHeader: true);
            var rows =  _importer.QueryExcel(path.ToString(), true).ToList();
            Assert.Equal(1, rows[0].id);
...
#pragma warning disable CS0618 // Type or member is obsolete
        using var dt =  _importer.QueryExcelAsDataTable(path);
#pragma warning restore CS0618
    ...
    public void Issue122()
    {
        ...
        };
        {
            ...
            {
                var rows =  _importer.QueryExcel(path, useHeaderRow: true, configuration: config).ToList();
    ...
    public void Issue227()
    {
...

        {
            ...
            {
                var rows =  _importer.QueryExcel<MiniExcelOpenXmlTests.UserAccount>(path).ToList();
            ...
            {
                using var stream = File.OpenRead(path);
                var rows =  _importer.QueryExcel<MiniExcelOpenXmlTests.UserAccount>(stream).ToList();
                Assert.Equal(100, rows.Count);
...
#pragma warning disable CS0618 // Type or member is obsolete
        using var dt =  _importer.QueryExcelAsDataTable(path.ToString());
#pragma warning restore CS0618
    ...
    {
        {
            ...
            var rows =  _importer.QueryExcel(path, useHeaderRow: false, startCell: "C3", sheetName: "Sheet1").ToList();
            ...
            var columns =  _importer.GetExcelColumns(path, startCell: "C3");
            Assert.Equal(["C", "D", "E"], columns);
        }

        {
            var path = PathHelper.GetFile("xlsx/TestIssue147.xlsx");
            var rows =  _importer.QueryExcel(path, useHeaderRow: true, startCell: "C3", sheetName: "Sheet1").ToList();
            ...
            var columns =  _importer.GetExcelColumns(path, useHeaderRow: true, startCell: "C3");
    ...
    public void Issue216()
    {
        ...
        {
#pragma warning disable CS0618 // Type or member is obsolete
            using var table =  _importer.QueryExcelAsDataTable(path.ToString());
#pragma warning restore CS0618
        ...
        {
#pragma warning disable CS0618 // Type or member is obsolete
            using var dt =  _importer.QueryExcelAsDataTable(path.ToString(), false);
#pragma warning restore CS0618
    ...
    {
        {
            ...
            var A2 =  _importer.QueryExcel(path.ToString(), true).First().Test;
    ...
    public void Issue220()
    {
        ...
        var rows =  _importer.QueryExcel(path, useHeaderRow: true);
        var result = rows
            .GroupBy(s => s.PRT_ID)
            .Select(g => new
            {
    ...
    public void Issue215()
    {
        using var stream = new MemoryStream();
         _exporter.ExportExcel(stream, new[] { new { V = "test1" }, new { V = "test2" } });
        var rows =  _importer.QueryExcel(stream, true).ToList();
    ...
    public void Issue217()
    {
        ...
        {
            using var path = AutoDeletingPath.Create();
             _exporter.ExportExcel(path.ToString(), table);
    ...
    /// <summary>
    /// _ _exporter.ExportExcel(path, table,sheetName:“Name”) ，the actual sheetName is Sheet1
    ...
    public void Issue212()
    {
        ...
        using var path = AutoDeletingPath.Create();
         _exporter.ExportExcel(path.ToString(), new[] { new { x = 1, y = 2 } }, sheetName: sheetName);
    ...
    public void Issue87()
    {
        ...
        var rows =  _importer.QueryExcel(templatePath).ToList();
         _templater.ApplyXlsxTemplate(path.ToString(), templatePath, value);
    }
    ...
    public void Issue208()
    {
        ...
        var columns =  _importer.GetExcelColumns(path).ToList();
    ...
    public void Issue150()
    {
        ...
        Assert.Throws<NotSupportedException>(() =>  _exporter.ExportExcel(path, new[] { 1, 2 }));
        File.Delete(path);
        ...
        Assert.Throws<NotSupportedException>(() =>  _exporter.ExportExcel(path, new[] { DateTime.Now }));
        File.Delete(path);

        Assert.Throws<NotSupportedException>(() =>  _exporter.ExportExcel(path, new[] { Guid.NewGuid() }));
        File.Delete(path);
    }
    ...
    {
        {
            ...
            var input = JsonConvert.DeserializeObject<IEnumerable<MiniExcelOpenXmlTests.UserAccount>>(
                ...
                """);
             _exporter.ExportExcel(path, input);
        ...
        }
        {
            ...
            {
                var rows =  _importer.QueryExcel<MiniExcelOpenXmlTests.UserAccount>(path, sheetName: "Sheet1").ToList();
    ...
    public void Issue149()
    {
...

        {
            ...
            var rows =  _importer.QueryExcel(path).Select(s => (string)s.A).ToList();
...

        {
            ...
            var rows =  _importer.QueryExcel(path.ToString(), true).Select(s => (string)s.Test).ToList();
            for (int i = 0; i < chars.Length; i++)
            {
...

        {
            ...
            var rows =  _importer.QueryExcel<Issue149VO>(path.ToString()).Select(s => s.Test).ToList();
            for (int i = 0; i < chars.Length; i++)
            {
                _output.WriteLine($"{i}, {chars[i]}, {rows[i]}");
                if (i is 13 or 9 or 10)
    ...
    public void Issue153()
    {
        ...
        var rows =  _importer.QueryExcel(path, true).First() as IDictionary<string, object>;
        Assert.Equal(
        [
    ...
    public void Issue137()
    {
        ...
        {
            var rows =  _importer.QueryExcel<Issue137ExcelRow>(path).ToList();
            Assert.Equal(10, rows.Count);
            {
                var row = rows[0];
    ...
    public void Issue138()
    {
        ...
        }
        {
            ...
            var rows =  _importer.QueryExcel<Issue138ExcelRow>(path).ToList();
            Assert.Equal(6, rows.Count);
    ...
    public void Issue527()
    {
        ...
        var rows =  _importer.QueryExcel(path.FilePath).ToList();
    ...
    public void TestIssue584()
    {
        ...
        using var path = AutoDeletingPath.Create();
         _exporter.ExportExcel(path.FilePath, reader, configuration: excelconfig, overwriteFile: true);
    ...
    public void Issue585()
    {
        ...
        var items1 =  _importer.QueryExcel<Issue585VO1>(path);
        Assert.Equal(2, items1.Count());

        var items2 =  _importer.QueryExcel<Issue585VO2>(path);
        Assert.Equal(2, items2.Count());

        var items3 =  _importer.QueryExcel<Issue585VO3>(path);
    ...
    public void Issue_542()
    {
        ...
        var resultWithoutFirstRow =  _importer.QueryExcel<Issue542>(path).ToList();
        var resultWithFirstRow =  _importer.QueryExcel<Issue542>(path, treatHeaderAsData: true).ToList();
    ...
    public void TestIssue627()
    {
        ...
        var rowsWritten =  _exporter.ExportExcel(path.ToString(), value, configuration: config);
    ...
    public void Issue632_1()
    {
        ...
        var path = Path.Combine(
         ...
         _exporter.ExportExcel(path, values, configuration: config, overwriteFile: true);
        File.Delete(path);
    }
    ...
    public void Issue_658()
    {
        ...
        var rowsWritten =  _exporter.ExportExcel(memoryStream, testData, configuration: new OpenXmlConfiguration
        {
            FastMode = true
        });
        Assert.Single(rowsWritten);
        ...
        var queryData =  _importer.QueryExcel<Issue658TestData>(memoryStream).ToList();
    ...
    public async Task Issue_658_async()
    {
        ...
        var queryData =  _importer.QueryExcelAsync<Issue658TestData>(memoryStream).ToBlockingEnumerable().ToList();
    ...
    public void Issue_686()
    {
        ...
        Assert.Throws<InvalidDataException>(() =>
             _importer.QueryExcelRange(path, useHeaderRow: false, startCell: "ZZFF10", endCell: "ZZFF11").First());

        Assert.Throws<InvalidDataException>(() =>
             _importer.QueryExcelRange(path, useHeaderRow: false, startCell: "ZZFF@@10", endCell: "ZZFF@@11").First());
    }
    ...
    public void Test_Issue_693_SaveSheetWithLongName()
    {
        ...
        Assert.Throws<ArgumentException>(() =>  _exporter.ExportExcel(path1.ToString(), data, sheetName: "Some Really Looooooooooong Sheet Name"));
         _exporter.ExportExcel(path2.ToString(), new List<Dictionary<string, object>>());
        Assert.Throws<ArgumentException>(() =>  _exporter.InsertExcelSheet(path2.ToString(), data, sheetName: "Some Other Very Looooooong Sheet Name"));
    }
    ...
    public void Test_Issue_697_EmptyRowsStronglyTypedQuery()
    {
        ...
        var rowsIgnoreEmpty =  _importer.QueryExcel<Issue697>(path, configuration: new OpenXmlConfiguration { IgnoreEmptyRows = true }).ToList();
        var rowsCountEmpty =  _importer.QueryExcel<Issue697>(path).ToList();
    ...
    public void Issue_710()
    {
        ...
        using var memoryStream = new MemoryStream();
         _exporter.ExportExcel(memoryStream, values, configuration: new OpenXmlConfiguration
        {
            FastMode = true
        });

        memoryStream.Position = 0;
        using var dataReader =  _importer.GetExcelDataReader(memoryStream, useHeaderRow: false);
    ...
    public void TestIssue750()
    {
        ...
        var rows =  _importer.QueryExcel(path.ToString())
            .Skip(1453)
            .Take(2)
            .ToList();
    ...
    public void TestIssue763()
    {
        ...
        var rows =  _importer.QueryExcelRange(path, startCell: "A3", endCell: "J3").ToArray();
    ...
    public void TestIssue768()
    {
        ...
        var data = new Dictionary<string, object>
        {
         ...
         _templater.ApplyXlsxTemplate(path.ToString(), templatePath, data);
        var rows =  _importer.QueryExcel(path.ToString(), startCell: "A16").ToList();
    ...
    public void TestIssue186()
    {
        ...
        [
         ...
         _exporter.AddExcelPicture(path.FilePath, images);
    }
    ...
    public void TestIssue772()
    {
        ...
        var rows =  _importer.QueryExcel(path, sheetName: "Supply plan(daily)", startCell: "A1")
