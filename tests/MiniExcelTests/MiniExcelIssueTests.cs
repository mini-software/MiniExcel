    ...
    public partial class MiniExcelIssueTests
    {
        ...
        public void TestIssue24020201()
        {
            ...
            }
            {
                ...
                var data = new
                {
                    B = new[] {new{ ITM=1 },new{ ITM=2 }, new{ ITM=3 },}
                };
                MiniExcel.SaveAsByTemplate(path, templatePath, data);
            }
            {
